...
class CookieAuthFilter(private val authProviderService: AuthProviderService) :
    ...
    override fun doFilterInternal(
        ...
        try {
            ...
            // Perform the Session Cookie validation and authentication process for non-public
            // endpoints
            ...
            setErrorResponse(
                ...
                response,
                ErrorCode.SESSION_COOKIE_NOT_FOUND_IN_HEADER
            )
    ...
    private fun isPublicEndpoint(request: HttpServletRequest): Boolean {
        ...
        return requestURI.contains("/api/swagger-ui/") || requestURI.contains("/api/api-docs")
    }
}
