            ...
            ApiResponse(
                ...
                [
                    Content(
                        schema =
                        Schema(
                            implementation = PaymentResponseDto.PaymentRequestResponse::class
                        )
                    )
                ]
            ),
            ...
            ApiResponse(
                ...
                [
                    Content(
                        schema =
                        Schema(
                            implementation = PaymentResponseDto.PaymentCheckResponse::class
                        )
                    )
                ]
            ),
            ...
            ApiResponse(
                ...
                [
                    Content(
                        schema =
                        Schema(
                            implementation = PaymentResponseDto.PaymentRefundResponse::class
                        )
                    )
                ]
            ),
            ...
            ApiResponse(
                ...
                [
                    Content(
                        schema =
                        Schema(
                            implementation = PaymentResponseDto.PaymentNotMatchingRefundResponse::class
                        )
                    )
                ]
            ),
