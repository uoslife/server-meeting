...
class MatchApi(
    ...
    // MatchInformationResponse::class))]
    //                ),
    //                ApiResponse(
    //                    responseCode = "400",
    ...
    //                                            value =
    //                                                "{message: User is not Found., status: 400,
    // code: U02}"
    //                                        ),
    //                                        ExampleObject(
    //                                            name = "MT01",
    ...
    //                                            value =
    //                                                "{message: Match is not Found., status: 400,
    // code: MT01}"
    //                                        ),
    //                                        ExampleObject(
    //                                            name = "M06",
    ...
    //                                            value =
    //                                                "{message: Meeting Team is not Found., status:
    // 400, code: M06}"
    //                                        ),
    //                                        ExampleObject(
    //                                            name = "M08",
    ...
    //                                            value =
    //                                                "{message: Preference is not Found., status:
    // 400, code: M08}"
    //                                        ),
    //                                        ExampleObject(
    //                                            name = "M07",
    ...
    //                                            value =
    //                                                "{message: Information is not Found., status:
    // 400, code: M07}"
    //                                        )]
    //                            )]
    //                ),
    ...
    //                                        ExampleObject(
    //                                            value =
    //                                                "{message: Token is not valid., status: 401,
    // code: T01}"
    //                                        )]
    //                            )]
    //                ),
