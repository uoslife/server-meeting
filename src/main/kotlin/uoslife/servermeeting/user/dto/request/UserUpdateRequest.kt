...
data class UserUpdateRequest(
    @Schema(description = "이름", example = "유현승")
    @field:NotNull
    val name: String,
    ...
    @field:NotNull @field:Size(max = 11)
    ...
    @Schema(description = "카카오톡 아이디", example = "__uhyun")
    @field:NotNull
    ...
    @Schema(description = "키", example = "178")
    val height: Int?,

    @Schema(description = "종교", example = "")
    val religion: ReligionType?,

    @Schema(description = "이름", example = "[NO_RELIGION]")
    val drinkingMin: Int?,

    @Schema(description = "최대 주량(병)", example = "3")
    val drinkingMax: Int?,

    @Schema(description = "흡연 여부", example = "[FALSE]")
    val smoking: SmokingType?,

    @Schema(description = "동물상", example = "[DOG]")
    val spiritAnimal: List<SpiritAnimalType>?,

    @Schema(description = "MBTI", example = "INFP")
    val mbti: String?,

    @Schema(description = "흥미", example = "[EXERCISE]")
